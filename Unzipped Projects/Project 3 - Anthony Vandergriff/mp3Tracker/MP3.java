...
public class MP3 implements Comparable
{
	 ...
	 */
	public double compareTo (MP3 compareMP3)
	{
		double comparePlayback=((MP3)compareMP3).getPlaybackTime();
		return this.playbackTime-comparePlayback;
	}
